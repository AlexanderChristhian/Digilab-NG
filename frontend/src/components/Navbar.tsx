            ...
            {isAuthenticated ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-1 text-primary-100 hover:text-white dark:text-primary-200 dark:hover:text-white transition-colors"
                >
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-10">
                    <Link
                      to="/profile"
                      className="block px-4 py-2 text-sm text-secondary-700 dark:text-dark-text hover:bg-secondary-100 dark:hover:bg-gray-700"
                    ...
                    <button
                      ...
                      className="block w-full text-left px-4 py-2 text-sm text-secondary-700 dark:text-dark-text hover:bg-secondary-100 dark:hover:bg-gray-700"
                    >
                      Sign out
                    </button>
                  </div>
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="block w-full text-left py-2 px-3 text-primary-100 hover:text-white dark:text-primary-200 dark:hover:text-white transition-colors"
                >
                  Sign out
                </button>
              </>
