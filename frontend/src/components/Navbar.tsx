      ...
      <div className="container-custom">
            ...
            {isAuthenticated ? (
              <div className="relative">
                <button
                  ...
                  className="menu-item flex items-center space-x-1 text-primary-100 hover:text-white dark:text-primary-200 dark:hover:text-white transition-colors"
                >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-3 px-2 space-y-3 border-t border-white/20 dark:border-dark-border mobile-menu-enter-active">
            ...
            <Link
              to="/classes"
              className="block py-2 px-3 text-primary-100 hover:text-white dark:text-primary-200 dark:hover:text-white transition-colors menu-item"
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/register"
                  className="block py-2 px-3 bg-primary-gradient hover:opacity-90 dark:bg-gradient-to-br dark:from-slate-900 dark:to-zinc-900 rounded-md text-white transition-all btn-hover hover:scale-105"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Register
                </Link>
